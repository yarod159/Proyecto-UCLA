...
var _excluded4 = ["animation", "className", "component", "height", "style", "variant", "width"];
var _2 = (t) => t;
var _t5;
var _t22;
var _t32;
...
var Skeleton = React4.forwardRef(function Skeleton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSkeleton"
  });
...
var SwitchSwitchBase = styled_default(SwitchBase_default, {
  ...
  [`&.${switchClasses_default.checked}`]: {
    ...
    [`&.${switchClasses_default.disabled}`]: {
      color: theme.vars ? theme.vars.palette.Switch[`${ownerState.color}DisabledColor`] : `${theme.palette.mode === "light" ? (0, import_colorManipulator.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator.darken)(theme.palette[ownerState.color].main, 0.55)}`
    }
  },
  [`&.${switchClasses_default.checked} + .${switchClasses_default.track}`]: {
...
//# sourceMappingURL=chunk-S36X2LLV.js.map
