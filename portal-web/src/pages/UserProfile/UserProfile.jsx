    ...
    <div>
        <UserNavBar/>
            ...
            <Stack direction="row" spacing={8}
                sx={{marginBottom:'8px', marginLeft:'180px', marginTop:'8px'
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Grid item xs={12}>
                    <Button type="submit" variant="contained" fullWidth sx={{bgcolor:'#18a0a6', color:'#fff', ":hover":{bgcolor:'#fff', color:'#18a0a6'}}}>
                    Modificar Datos
                    </Button>
                </Grid>
                </Grid>
                ...
                <Item>
                    <Card sx={{ 
                        ...
                        paddingTop:'40px' }}>
                        <CardContent>
                            <Avatar sx={{ bgcolor: 'deepOrange[500]', width: 56, height: 56, margin: '0 auto', marginBottom:'12px'}}>
